...
namespace GeradorDO
{
    ...
    public class MySQLDO
    {
        ...
        public StringBuilder GeraCodigoDO(string _banco, string _conexao)
        {
            ...
            //atributos
            objCodigo.AppendLine(tb + tb + "private MySqlConnection oConnection = null;");
            objCodigo.AppendLine(tb + tb + "private string connectionString = null;");
            objCodigo.AppendLine(tb + tb + "private MySqlDataAdapter oDataAdapter = null;");
            objCodigo.AppendLine(tb + tb + "private MySqlCommand oCommand = null;");
            ...
            objCodigo.AppendLine(tb + tb + tb + "oConnection = new MySqlConnection(connectionString);");
            objCodigo.AppendLine(tb + tb + "}");
            //Metodos
            ...
            objCodigo.AppendLine(tb + tb + tb + tb + "oCommand = new MySqlCommand(sSQL, oConnection);");
            ...
            objCodigo.AppendLine(tb + tb + tb + "{");
            objCodigo.AppendLine(tb + tb + tb + tb + "oConnection.Open();");
            objCodigo.AppendLine(tb + tb + tb + tb + "oCommand = new MySqlCommand(command, oConnection);");
            objCodigo.AppendLine(tb + tb + tb + tb + "oDataAdapter = new MySqlDataAdapter(oCommand);");
            ...
            objCodigo.AppendLine(tb + tb + tb + "}");
            objCodigo.AppendLine(tb + tb + tb + "catch (MySqlException err)");
            objCodigo.AppendLine(tb + tb + tb + "{");
            objCodigo.AppendLine(tb + tb + tb + tb + "throw err;");
            objCodigo.AppendLine(tb + tb + tb + "}");
            objCodigo.AppendLine(tb + tb + tb + "finally");
            ...
            objCodigo.AppendLine(tb + tb + "public MySqlDataReader QueryConsulta(string command)");
            objCodigo.AppendLine(tb + tb + "{");
            objCodigo.AppendLine(tb + tb + tb + "try");
            objCodigo.AppendLine(tb + tb + tb + "{");
            objCodigo.AppendLine(tb + tb + tb + tb + "oConnection.Open();");
