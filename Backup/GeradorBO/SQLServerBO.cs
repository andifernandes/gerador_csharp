    ...
    public class SQLServerBO
    {
        ...
        public StringBuilder GeraCodigoBO(string strTabela, string _conexao, string _banco)
        {
            ...
            if (strTabela != string.Empty)
            {
                ...
                // atributos
                objCodigo.AppendLine(tb + tb + "private SQLServer." + _banco + " objDO = null;");
                ...
                // Abre conexão
                objBanco = new Banco.SQLServer(_conexao);
                ...
                objCodigo.AppendLine();
                objCodigo.AppendLine(tb + tb + tb + tb + "objDO = new SQLServer." + _banco + "();");
                objCodigo.AppendLine();
                ...
                objCodigo.AppendLine(tb + tb + "public int Insert(SQLServer." + strTabela + "VO _vo)");
                objCodigo.AppendLine(tb + tb + "{");
                objCodigo.AppendLine(tb + tb + tb + "try");
                objCodigo.AppendLine(tb + tb + tb + "{");
                objCodigo.AppendLine(tb + tb + tb + tb + "strSql = new StringBuilder();");
                ...
                objCodigo.AppendLine(tb + tb + "/// <param name=\"_vo\">objetos vo do banco</param>");
                objCodigo.AppendLine(tb + tb + "/// <returns>int</returns>");
                objCodigo.AppendLine(tb + tb + "public int Update(SQLServer." + strTabela + "VO _vo)");
                objCodigo.AppendLine(tb + tb + "{");
                objCodigo.AppendLine(tb + tb + tb + "try");
                objCodigo.AppendLine(tb + tb + tb + "{");
                objCodigo.AppendLine(tb + tb + tb + tb + "strSql = new StringBuilder();");
                ...
                objCodigo.AppendLine(tb + tb + "/// <param name=\"_vo\">objetos vo do banco</param>");
                objCodigo.AppendLine(tb + tb + "/// <returns>int</returns>");
                objCodigo.AppendLine(tb + tb + "public int Delete(SQLServer." + strTabela + "VO _vo)");
                objCodigo.AppendLine(tb + tb + "{");
                objCodigo.AppendLine(tb + tb + tb + "try");
                objCodigo.AppendLine(tb + tb + tb + "{");
                objCodigo.AppendLine(tb + tb + tb + tb + "strSql = new StringBuilder();");
                ...
                objCodigo.AppendLine(tb + tb + tb + tb + "strSql.Append(\" SELECT COLUNAS.name AS COLUNA, TIPOS.name AS TIPO, COLUNAS.length AS TAMANHO, COLUNAS.isnullable AS EH_NULO \");");
                objCodigo.AppendLine(tb + tb + tb + tb + "strSql.Append(\" FROM sys.sysobjects AS TABELAS INNER JOIN \");");
                objCodigo.AppendLine(tb + tb + tb + tb + "strSql.Append(\" sys.syscolumns AS COLUNAS ON TABELAS.id = COLUNAS.id INNER JOIN \");");
                objCodigo.AppendLine(tb + tb + tb + tb + "strSql.Append(\" sys.systypes AS TIPOS ON COLUNAS.usertype = TIPOS.usertype \");");
                objCodigo.AppendLine(tb + tb + tb + tb + "strSql.Append(\" WHERE (TABELAS.name = \'" + strTabela + "\') \");");
